...
## 🫨 What is it?
The **GrindWise** is a Chrome Extension designed to simulate a real technical interview. Instead of giving up and looking at the full solution, this extension acts as your interviewer, providing **3 progressive, AI-generated hints** to nudge you in the right direction. 
...
*   **Progressive AI Hints:**
    ...
    *   **Hint 3 (Pseudocode):** Provides partial logic without giving away the answer.
*   **Bring Your Own AI:** Choose between Groq (Llama 3), Google Gemini, OpenAI, Anthropic Claude, or Cohere.
...
5. Click the extension icon in your browser toolbar to open the settings panel.
